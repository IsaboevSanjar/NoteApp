...
class BottomSheetFragment : BottomSheetDialogFragment() {
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.bottom_sheed_fragment, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<LinearLayout>(R.id.by_instagram).setOnClickListener(View.OnClickListener {
